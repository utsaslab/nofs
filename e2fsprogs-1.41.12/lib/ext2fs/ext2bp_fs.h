/*
 *  linux/include/linux/ext2bp_fs.h
 *
...
/* Vijay Chidambaram (vijayc@cs.wisc.edu)
   Adding changes in order to add backpointers to the ext2 filesystem.
   Changes include:
	1. Adding validity bitmaps to the group descriptors
	2. Changing the inode structure to add 32 i_backlinks;
*/
...
struct ext2_group_desc
{
	...
	__u16	bg_flags;
	/* Previously, there were 2 reserved 32 bit integers here,
	   serving as null buffers. 

	   Now that space has been reclaimed for blocks for the 
	   validity bitmaps. */
	__u32	bg_valid_block_bitmap;	/* Blocks Validity bitmap block */
	__u32	bg_valid_inode_bitmap;	/* Inodes Validity bitmap block */
...
/* Vijay: Modifying this to add num_links fields, and incoming links */
