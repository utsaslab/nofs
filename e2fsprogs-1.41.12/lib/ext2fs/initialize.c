...
// name is device name
// flags denote whether it is RW etc
// I/O manager holds the function pointers for reading a block, etc, dealing with actual device
			    ...
			    io_manager manager, ext2_filsys *ret_fs)
{
	...
	// Getting memory for the super block
...
#define set_field(field, default) (super->field = param->field ? \
	...
	// Not quite sure where params get blocks count
