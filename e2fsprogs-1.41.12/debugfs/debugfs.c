...
void internal_dump_inode(FILE *out, const char *prefix,
			 ...
			 int do_dump_blocks)
{
	fprintf(out,"Vijay: inside dump_blocks\n");
	fprintf(out,"Accessing inode's new field 0: %d\n", inode->i_backlinks[0]);	
	fprintf(out,"Accessing inode's new field 1: %d\n", inode->i_backlinks[1]);	
	fprintf(out,"Accessing inode's new field 2: %d\n", inode->i_backlinks[2]);	
	fprintf(out,"Accessing inode's new field 3: %d\n", inode->i_backlinks[3]);	
	fprintf(out,"Accessing inode's new field 4: %d\n", inode->i_backlinks[4]);	
	fprintf(out,"Accessing inode's new field 5: %d\n", inode->i_backlinks[5]);	
...
void do_modify_inode(int argc, char *argv[])
{
	...
	modify_u32(argv[0], "Backlink 0", decimal_format, &inode.i_backlinks[0]);
